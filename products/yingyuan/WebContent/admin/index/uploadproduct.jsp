...
%>
	...
	    		
					...
					<div class="layui-form-item">
						<div class="layui-input-block">
							<button  class="layui-btn layui-btn-normal" lay-submit lay-filter="formDemo">立即录入</button>
			...
			layui.use(['form'], function() {
				...
				            });
				 ...
				 $.ajax({
					 ...
					 type:"post",
					 data:{name:name,director:director,mainactor:mainactor,duration:duration,speak:speak,jianjie:jianjie,arr:arr,img:img},
					 url:"<%=basePath %>insertmovie",
					 dataType:"json",
